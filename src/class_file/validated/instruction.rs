...
pub enum Instruction {
    ...
    AReturn,
    Return,
    GetStatic(Arc<FieldRef>),
    PutStatic(Arc<FieldRef>),
    GetField(Arc<FieldRef>),
    PutField(Arc<FieldRef>),
    InvokeVirtual(Arc<MethodRef>),
    InvokeSpecial(Arc<MethodRef>),
    InvokeStatic(Arc<MethodRef>),
    InvokeInterface(Arc<MethodRef>, u8),
    ...
    ArrayLength,
    AThrow,
    CheckCast(Arc<String>),
    InstanceOf(Arc<String>),
    MonitorEnter,
    MonitorExit,
    MultiANewArray(Arc<String>, u8),
    IfNull(i16),
    IfNonNull(i16),
    GotoW(i32),
    JsrW(i32),
